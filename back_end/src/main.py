...
import argparse
# python main.py /Users/pianjiliangcha/Desktop/范霈璐和陆龙政.mp3
# python main.py /Users/pianjiliangcha/Desktop/0715CSCW/02代码检测/数据/09白一茗组.wav
...
parser.add_argument("--delta", default=8, type=float, help="Maximum distance threshold delta new")
...
parser.add_argument("--max-speakers", default=4, type=int, help="Maximum number of identifiable speakers")
parser.add_argument(
    "--output", type=str,
